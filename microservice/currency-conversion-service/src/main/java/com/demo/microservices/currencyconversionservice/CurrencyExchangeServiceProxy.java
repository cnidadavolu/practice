...
//@FeignClient(name = "currency-exchange-service") //When we using RibbonClient no need to give url
@FeignClient(name = "netflix-zuul-api-gateway-server") //Replacing Naming Server with Zuul API Gateway
